            ...
            <div class="row" style="background-color: #1c0a22">
                ...
                <div class="col" id="resize-left">
                    ...
                    <div class="col-8" style="float: right">
                        ...
                        <br>
                        <br>
                        <a class="btn button-tag" id="border" href="./product-page.php">Details</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <button class="button-tag" id="border" style="float: right">Learn more</button>
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col">
                ...
                <div class="text-block">
                    ...
                    <div class="stick-right">
                        33%
                        <button class="button-landing">15,55$</button>
                    </div>
                </div>
            </div>
            <div class="col">
